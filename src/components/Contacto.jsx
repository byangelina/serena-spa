...
function Contacto() {
  ...
  // Si venimos desde "Reservar en esta sucursal" (Sucursales.jsx), precargamos ese dato
  useEffect(() => {
    const sucursalGuardada = localStorage.getItem("serena_sucursal_elegida")
    if (sucursalGuardada) {
      setForm(prev => ({ ...prev, sucursal: sucursalGuardada }))
      localStorage.removeItem("serena_sucursal_elegida")
    }
  }, [])
